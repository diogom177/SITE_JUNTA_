...
<head>
  ...
  <title>História - Junta de Freguesia de Barreiro de Besteiros e Tourigo</title>
...
<body>
  ...
  <style>
    body {
      padding-top: 150px;
      /*para meter p baixo as divs do body*/
    }
  </style>
  ...
  <footer class="footer-meruge" style="margin-top: -30px;">
    <div class="footer-meruge-top">
      ...
      <div class="footer-meruge-section">
        <h4>Autarquia</h4>
        <ul>
          <li><a style="color: #22649A;" href="documentos.php">Pedido de Documentos</a></li>
