...
<head>
  ...
  <title>Sobre a Freguesia - Junta de Freguesia de Barreiro de Besteiros e Tourigo</title>
  ...
  </style> <!--baixar ou aumentar conforme for preciso-->
...
<body>
  ...
  <div class="navbar">
    <div class="logo">
      <a href="index.php">
        <img src="IMAGENS/logo_fb-removebg-preview.ico" alt="Brasão da Junta de Freguesia de Barreiro de Besteiros">
      </a>
      <div class="titulo">
        <strong>
          <p><a href="index.php"> Junta de Freguesia de Barreiro <br> de Besteiros </a></p>
        </strong>
      </div>
    </div>
